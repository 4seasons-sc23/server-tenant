...
public interface ParticipantJoinRepository extends QuerydslR2dbcRepository<ParticipantJoinEntity, UUID> {
    Flux<ParticipantJoinEntity> findByTenantIdAndParticipantIdAndApplicationSessionIdAndUpdatedAtIsNull(UUID tenantId, String participantId, UUID applicationSessionId);
